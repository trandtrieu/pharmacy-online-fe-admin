  ...
  render() {
    return (
      <div>
        <br></br>
        <div
          style={{ fontSize: "1.1rem", marginLeft: "150px" }}
          className="container"
        >
          <div className="row">
            <div
              ...
              <div className="card-body">
                <form>
                  ...
                  <div className="form-group">
                    ...
                    <input
                      placeholder="Type DosageAndUsage"
                      name="dosageAndUsage"
                      className="form-control"
                      value={this.state.dosageAndUsage}
                      onChange={this.changeDosageAndUsage}
                    />
                  </div>
                  <div className="form-group">
                    <label> Product Indications: </label>
                    <input
                      placeholder="Type Indications"
                      name="indications"
                      className="form-control"
                      value={this.state.indications}
                      onChange={this.changeIndications}
                    />
                  </div>
                  ...
                  <div className="form-group">
                    ...
                    <input
                      placeholder="Type SideEffects"
                      name="sideEffects"
                      className="form-control"
                      value={this.state.sideEffects}
                      onChange={this.changeSideEffects}
                    />
                  </div>
                  <div className="form-group">
                    <label> Product Precautions: </label>
                    <input
                      placeholder="Type Precautions"
                      name="precautions"
                      className="form-control"
                      value={this.state.precautions}
                      onChange={this.changePrecautions}
                    />
                  </div>
                  ...
                  <div className="form-group">
                    ...
                    <input
                      placeholder="Type Contraindications"
                      name="contraindications"
                      className="form-control"
                      value={this.state.contraindications}
                      onChange={this.changeContraindications}
                    />
                  </div>
                  <div className="form-group">
                    <label> Product DrugInteractions: </label>
                    <input
                      placeholder="Type DrugInteractions"
                      name="drugInteractions"
                      className="form-control"
                      value={this.state.drugInteractions}
                      onChange={this.changeDrugInteractions}
                    />
                  </div>
                  <div className="row">
                    <div className="form-group col-md-6">
                      ...
                      <input
                        ...
                        onChange={this.changeMadein}
                        onBlur={this.checkMadeIn}
                      />
