...
class AccountUpdate extends Component {
    ...
    updateUser = e => {
        ...
        if (!this.state.name || !this.state.mail || !this.state.phone || !this.state.username) {
            this.setState(
                {
                    allMS: "Check again!"
                }
                                    ...
                                    <div className='card-body'>
                                        <form action="">
                                            ...
                                            <div className='form-group'>
                                                ...
                                                <input placeholder='Username' id='Username' name='name' className='form-control' value={this.state.username} onBlur={this.validateUsername} onChange={this.changeUsernameHandler} type="text" />
                                            </div>
                                            ...
                                            <div className='form-group'>
                                                ...
                                                <input placeholder='DOB' id="dob" name='email' className='form-control' defaultValue="2012-01-01" onBlur={this.validateDob} value={this.state.dob} onChange={this.changeDOBHandler} type="date" />
                                            </div>
