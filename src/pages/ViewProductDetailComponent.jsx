  ...
  render() {
    return (
      <div
        ...
        style={{ marginLeft: "20%", height: "100vh" }}
      >
                  ...
                  <div className="col-md-6">
                    <div className="images p-3">
                      ...
                      <div className="thumbnail text-center">
                        <p>
                          <b>Price:</b> {this.state.productDetail.price} $
                        </p>
                        <p>
                          <b>Quantity:</b> {this.state.productDetail.quantity}
                        </p>
                        <p>
                          <b>Category:</b>{" "}
                          {this.state.productDetail.category_name}
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="product p-4">
                      ...
                      <div className="mt-4 mb-3">
                        ...
                        <span className="text-uppercase text-muted brand">
                          <b>Brand:</b> {this.state.productDetail.brand}
                        </span>
                      ...
                      >
                        <p>
                          <b>DrugInteractions: </b>
                          {this.state.productDetail.drugInteractions}
                        </p>
                        <p>
                          <b>Contraindications: </b>
                          {this.state.productDetail.contraindications}
                        </p>
                        <p>
                          <b>Ingredients: </b>
                          {this.state.productDetail.ingredients}
                        </p>
                        <p>
                          <b>Packaging: </b>
                          {this.state.productDetail.packaging}
                        </p>
                        <p>
                          <b>SideEffects: </b>
                          {this.state.productDetail.sideEffects}
                        </p>
                        <p>
                          <b>Storage: </b>
                        ...
                        <p>
                          <b>Packaging: </b>
                          {this.state.productDetail.dosageAndUsage}
                        </p>
                        <p>
                          <b>DosageAndUsage: </b>
                          {this.state.productDetail.dosageAndUsage}
                        ...
                        <p>
                          <b>MadeIn: </b>
                          {this.state.productDetail.madeIn}
                        </p>
                        <p>
                          <b>Precautions: </b>
                          {this.state.productDetail.precautions}
                        </p>
                        <p>
                          <b>Indications: </b>
                          {this.state.productDetail.indications}
                        </p>
                      </p>
